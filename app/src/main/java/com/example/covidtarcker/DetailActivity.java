package com.example.covidtarcker;
...
public   int positionCountry;
    TextView tvCountry,tvCases,tvRecovered,tvCritical,tvActive,tvTodayCases,TotalDeaths,tvTodayDeaths;
    @Override
    ...
    protected void onStart() {
        ...
        TotalDeaths.setText(AffectedCountries.countryModelsList.get(positionCountry).getDeaths());
